motivational={
    ...
    "Confusius" :["Our greatest glory is not in never falling, but in rising every time we fall.",
...
literature={
    'Margaret Atwood'  : ['The answers you get from literature depends on the questions you pose .',
    ...
    'John Updike'  : ['Writers may be disreputable, in corrigible, early to decay or late to bloom but they dare to go it alone',
    ...
    'Italo Calvino' : ['one writes fables in periods of oppression.',
...
jokes=["Did you hear about the crook who stole a calendar? He got twelve months.",
       ...
       "My friend changed a lot after she became vegan.Its like I've never seen herbivore.",
